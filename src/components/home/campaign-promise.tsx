    ...
    <section className="campaign-promise" aria-labelledby="campaign-promise-title">
      <div className="shell campaign-promise__inner">
        ...
        <div>
          ...
          <p>
            Trees have given us shade, fresh air, beauty and life—quietly, every single day. This
            Raksha Bandhan, let’s celebrate everything they give us with a simple gesture of gratitude.
          </p>
        </div>
        {movementWallEnabled ? (
